    ...
    <div class="site-footer__grid">
        ...
        <div>
            ...
            <ul>
                ...
                <li><a href="<?= htmlspecialchars(Helpers::pageUrl('return-policy'), ENT_QUOTES, 'UTF-8') ?>">İade Politikası</a></li>
                <li><a href="<?= htmlspecialchars(Helpers::pageUrl('privacy-policy'), ENT_QUOTES, 'UTF-8') ?>">Gizlilik Politikası</a></li>
            </ul>
        </div>
        <div>
