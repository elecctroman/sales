 ...
 * Description: WooCommerce siparişlerini Customer yönetim sistemine aktarır ve durum güncellemelerini senkronize eder.
 * Version: 1.0.0
        ...
        <div class="wrap">
            ...
            <form method="post" action="">
                ...
                <table class="form-table" role="presentation">
                    <tbody>
                    <tr>
                        <th scope="row"><label for="reseller-sync-email"><?php esc_html_e('Customer E-postası', 'reseller-sync'); ?></label></th>
                        <td>
                            <input name="<?php echo esc_attr(self::OPTION_EMAIL); ?>" type="email" id="reseller-sync-email" value="<?php echo esc_attr($email); ?>" class="regular-text" placeholder="Customer@ornek.com">
                            <p class="description"><?php esc_html_e('Customer panelinde tanımlı e-posta adresinizi girin.', 'reseller-sync'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Customer panelindeki profil bölümünden aldığınız API anahtarı.', 'reseller-sync'); ?></p>
                        </td>
                    </tr>
                    </tbody>
                </table>
